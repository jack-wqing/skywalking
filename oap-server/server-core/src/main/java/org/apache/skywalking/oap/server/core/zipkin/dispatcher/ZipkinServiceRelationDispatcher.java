...
public class ZipkinServiceRelationDispatcher implements SourceDispatcher<ZipkinServiceRelation> {
    ...
    @Override
    public void dispatch(ZipkinServiceRelation source) {
        ZipkinServiceRelationTraffic traffic = new ZipkinServiceRelationTraffic();
        traffic.setServiceName(source.getServiceName());
        traffic.setRemoteServiceName(source.getRemoteServiceName());
