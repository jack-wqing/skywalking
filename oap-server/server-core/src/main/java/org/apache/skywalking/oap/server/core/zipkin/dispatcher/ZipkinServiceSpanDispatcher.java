...
// ZipkinServiceSpan: Dispatcher

public class ZipkinServiceSpanDispatcher implements SourceDispatcher<ZipkinServiceSpan> {

    @Override
    public void dispatch(ZipkinServiceSpan source) {
        ZipkinServiceSpanTraffic traffic = new ZipkinServiceSpanTraffic();
        traffic.setServiceName(source.getServiceName());
        traffic.setSpanName(source.getSpanName());
